...
Serviço de API Rest para geração de clientes. Pode ser consumido por um módulo de um sistema, onde é possível gerar um cliente, pagar um cliente, cancelar um cliente e calcular os juros conforme a data de vencimento.
